                ...
                <section className="lg:mb-8 mb-2 text-center lg:text-left">
                    ...
                    <div className="grid gap-x-6 lg:grid-cols-3 items-center justify-center">
                        <div className="mb-12 lg:mb-0  border border-gray-300 rounded-lg p-8">
                            ...
                            <h5 className="mb-4 text-lg font-Bebas flex items-center justify-center text-align-center">BRANDING DESIGN</h5>
                            <p className="text-gray-500 dark:text-neutral-300 flex items-center justify-center text-center font-Monserat text-sm">
                        ...
                        <div className="mb-12 lg:mb-0  border border-gray-300 rounded-lg p-8">
                            ...
                            <h5 className="mb-4 text-lg font-Bebas flex items-center justify-center">DEVELOPMENT</h5>
                            <p className="text-gray-500 dark:text-neutral-300 flex items-center justify-center text-center font-Monserat text-sm">
                                We make the essence of your brand visible to the world
                            </p>
                        </div>
                        <div className="mb-12 lg:mb-0 border border-gray-300 rounded-lg p-8">
                            ...
                            <h5 className="mb-4 text-lg font-Bebas flex items-center justify-center">MARKETING</h5>
                            <p className="text-gray-500 dark:text-neutral-300 flex items-center justify-center text-center font-Monserat text-sm">
                                We make the essence of your brand visible to the world
                        </p>
                        </div>
