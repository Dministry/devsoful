...
import ProjectsCards28 from '../../public/ProjectsCards28.png'
    ...
    return (
        <>
            <div className="grid grid-cols-1 sm:grid-cols-4 sm:mx-auto gap-3 max-w-5xl mx-10 flex inline-flex justify-center my-14">
                <div>
                    <Image className="h-auto max-w-full rounded-lg" src={ProjectsCards23} alt="" onClick={() => setOpen(true)} />
                </div>
                <div>
                    <Image className="h-auto max-w-full rounded-lg" src={ProjectsCards24} alt="" onClick={() => setOpen(true)} />
                </div>
            </div>
            {/* Modal 1 */}
                ...
                <Dialog as="div" className="relative z-10" onClose={setOpen}>
                    ...
                    <FaSquareFull className="h-6 w-6 text-red-600" aria-hidden="true" />
                                    ...
                                    <div className="sm:flex sm:items-start">
                                        <Image src={ProjectsCards28} alt="test" />
