...
const Option = () => {
    ...
    if (expanded) {
        return (
            <>
                <div className=" border border-gray-300 py-4 flex flex-col justify-between transition-all duration-500 cursor-pointer">
                    <div className="bg-white py-24 sm:py-32">
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-2 lg:mx-6 lg:max-w-none lg:grid-cols-1 ring-1 ring-gray-200 rounded-xl">
                                {tiers.map((tier) => (
                                    <div
                                        key={tier.id}
                                    ...
                                    >
                                        <div className="flex items-center justify-center">
                                            {tier.mostPopular ? (
                                                <p className=" flex items-start justify-start w-full rounded-full bg-primary-100 px-12 py-2 text-xs font-Bebas leading-5 text-white">
                                                    RECOMMENDED
                                        </p>
                                            ) : null}
                                        ...
                                        <h3
                                            ...
                                            className={classNames(
                                                ...
                                                'text-lg font-Bebas leading-8 flex items-start justify-start'
                                            )}
                                        >
                                            {tier.name}
                                        </h3>
                                        {/* <p className="flex items-center justify-center font-Bebas mt-2 text-xs leading-6 text-gray-600">{tier.description}</p> */}
                                        <p className="flex items-start justify-start mt-0 text-xs text-center text-gray-500">{tier.subDescription}</p>
                                            ...
                                            <a
                                                ...
                                                className={classNames(
                                                    tier.mostPopular
                                                        ...
                                                        : 'text-primary-100 border border-primary-100 ring-primary-100 hover:ring-indigo-300 flex items-end justify-end',
                                                    'mt-6 rounded-full py-2 px-3 text-center text-sm font-Bebas leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                                                )}
                                            >
                                                TALK WITH US BEFORE ORDERING
                                        </a>
                                            <a href="">ORDER NOW</a>
                                        </div>
                                    </div>
        ...
        return (
            <div className="h-32 border border-gray-300 py-4 flex flex-col justify-between transition-all duration-500 cursor-pointer">
                ...
                <h2>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam magni vel perspiciatis cumque quod tenetur pariatur eos ullam est. Repudiandae mollitia qui possimus aut soluta officiis temporibus ad incidunt suscipit!</h2>
                <button
                    className="text-blue-500 underline focus:outline-none"
