...
export default function WebDevPageHeader() {
    return (
        <div className="">
            <Head>
                    ...
                    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto lg:mx-0">
                                <h2 className="flex items-center justify-center text-4xl font-Bebas tracking-tight text-white sm:text-6xl text-center">WEB DEVELOPMENT</h2>
                            </div>
